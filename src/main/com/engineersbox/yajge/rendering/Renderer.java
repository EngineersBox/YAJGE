...
//        renderAxes(camera);
    ...
    private void configureParticleShader() {
    ...
    private void renderSkyBox(final Scene scene) {
        ...
        if (skyBox != null) {
            ...
            this.skyboxShader.setUniform("viewModelMatrix", this.transform.buildVIewModelMatrix(skyBox, viewMatrix));
